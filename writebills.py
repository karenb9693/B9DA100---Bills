...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 21 22:05:38 2019
...
def get_newbill():
    ...
    if choice_month == 2 & (1 <= choice_day <= 28):
        Day = choice_day
    elif (choice_month == 4 or choice_month == 6 or choice_month == 9 or choice_month == 11) & (1 <= choice_day <= 30):
        Day = choice_day
    elif (choice_year % 4 == 0 & choice_year % 100 != 0 & choice_year % 400 == 0) & (choice_month == 2) & (1 <= choice_day <= 29):
        Day = choice_day
    elif (choice_month == 1 or choice_month == 3 or choice_month == 5 or choice_month == 7 or choice_month == 8 or choice_month == 10 or choice_month == 11) & (1 <= choice_day <= 31):
        Day = choice_day
    else:
        print("This is not a valid input")
    ...
    billsold = pd.read_csv('bills.csv', names=["Company", "Account Name", "Year","Month", "Day", "Value", "Type"])
